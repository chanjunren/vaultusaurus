...
export const REMARK_VAULTUSAURUS_INPUT = "remarkVaultusaurusInput.json";

export const OBSIDIAN_FILE_ID_PREFIX = "obs-doc";
export const OBSIDIAN_TAG_ID_PREFIX = "obs-tag";

export const VAULTUSAURUS_PLUGIN_FILES_PREFIX =
  ".docusaurus/docusaurus-plugin-vaultusaurus/default";
